...
Adding another ReBuild app is as easy as this:
```toml
[Some-App]
...
remove-rv-integrations-checks = true # remove checks from the ReBuild integrations

patches-source = "revanced/revanced-patches" # where to fetch patches bundle from. default: "revanced/revanced-patches"
cli-source = "j-hc/revanced-cli"             # where to fetch cli from. default: "j-hc/revanced-cli"
# options like cli-source can also set per app
rv-brand = "ReBuild Extended" # rebrand from 'ReVanced' to something different. default: "ReVanced"
